    ...
    <>
      ...
      >
        <div className="h-full flex justify-center items-center md:items-start flex-col row-span-2 col-span-2 md:col-span-1 md:row-span-1">
          <h1 className="text-[calc(2.2vw+15px)] leading-[1] text-[#eee] font-black tracking-wider w-full text-center md:text-start flex flex-col">
            <strong className="font-bold text-[calc(3vw+15px)] gradiente">
              Eleve e impulsione, <br />
            </strong>
            o nível do seu negócio
          </h1>
          <h3 className="text-[calc(1.1vw+15px)] text-[#eeeeee75] mt-[calc(20px-2vh)] mb-[calc(60px-2vh)] w-full text-center md:text-start">
