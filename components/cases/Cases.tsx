...
export const Cases = () => {
  ...
  return (
    <>
      <section
        id="cases"
        className="w-full flex flex-col justify-center items-center my-24"
      >
        <h1 className="text-[#eee] text-[2.5vw] font-bold tracking-wide mb-[calc(5vh+10px)]">
          Cases
        </h1>
        <div className="w-full grid grid-cols-2 justify-evenly items-center px-[20vw] gap-x-[10vw]">
          {casesData.map((project, index) => (
            <div
              ...
              key={index}
            >
              <Image src="/bg.png" alt="Imagem de fundo" width={1000} height={200} className="w-fit"/>
